...
super_admin_user = User.new(:super_admin)
super_admin_user.paid? # => false
super_admin_user.admin? # => false
super_admin_user.can_view_all_pages? # => true
super_admin_user.can_view_all_files # => true
</pre>
